...
const Work = () => {
  return (
    <div className="w-full p-[12%] py-10 scroll-mt-20" id="work">
        ...
        {workData.map((project, index) => (
          ...
          >
            ...
            >
              ...
              <div
                className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_2px_#000]
      ...
      py-3 px-10 mx-auto my-20 hover:bg-lime-300 transition duration-500
      ">
        Show More{" "}
        <Image
